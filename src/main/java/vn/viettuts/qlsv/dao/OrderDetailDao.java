...
import vn.viettuts.qlsv.entity.XML.OrderDetailXML;
...
public class OrderDetailDao {
    ...
    public void delete(OrderDetail orderDetail) {
        ...
        OrderDetail existingOrderDetail = orderDetailList.stream().filter(p -> p.getId().equals(orderDetailId) && p.getOrderId().equals(orderId)).findFirst().orElse(null);
    ...
    public int getId(String orderId) {
        return getProductByOrderId(orderId).size();
    }
}
